                             ...
                             u_char *bin, u_int32_t bin_size, void *user_data)
{
    ...
    for (i = 0; i < (bin_size + offset); i += BY2PG) {
        ...
        if (i == 0)
        {
            bcopy(bin, (void*)(page2kva(p) + offset), MIN((BY2PG - offset), bin_size));
        }
        ...
        else
        {
            ...
            bcopy((bin + i - offset), (void*)page2kva(p), (bin_size + offset - i));
        } 
    }
